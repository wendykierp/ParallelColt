...
/**
 * Abstract base class for 2-d matrices holding <code>float</code> elements. First
...
public abstract class FloatMatrix2D extends AbstractMatrix2D {
     ...
     * <code>a(1) == f(get(0,0)), a(0)==Float.NaN</code>.
     * <p>
     * <b>Example:</b>
     * 
     * <pre>
     ...
     * and terminators are
     * <code>a(1) == f(get(0,0),other.get(0,0)), a(0)==Float.NaN</code>.
     * <p>
     * <b>Example:</b>
     * 
     * <pre>
     ...
     * if the receiver is an instance of type <code>DenseFloatMatrix2D</code> the
     * new matrix must also be of type <code>DenseFloatMatrix2D</code>, if the
     * receiver is an instance of type <code>SparseFloatMatrix2D</code> the new
     * matrix must also be of type <code>SparseFloatMatrix2D</code>, etc. In
     ...
     * <code>DenseFloatMatrix2D</code> the new matrix must also be of type
     * <code>DenseFloatMatrix2D</code>, if the receiver is an instance of type
     * <code>SparseFloatMatrix2D</code> the new matrix must also be of type
     * <code>SparseFloatMatrix2D</code>, etc. In general, the new matrix should have
     ...
     * receiver is an instance of type <code>DenseFloatMatrix2D</code> the new
     * matrix must be of type <code>DenseFloatMatrix1D</code>, if the receiver is an
     * instance of type <code>SparseFloatMatrix2D</code> the new matrix must be of
     * type <code>SparseFloatMatrix1D</code>, etc.
     * 
     * @param size
     ...
     * instance of type <code>DenseFloatMatrix2D</code> the new matrix must be of
     * type <code>DenseFloatMatrix1D</code>, if the receiver is an instance of type
     * <code>SparseFloatMatrix2D</code> the new matrix must be of type
     * <code>SparseFloatMatrix1D</code>, etc.
     * 
     * @param size
     *            the number of cells the matrix shall have.
     * @param zero
