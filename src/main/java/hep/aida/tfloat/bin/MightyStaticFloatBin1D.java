...
public class MightyStaticFloatBin1D extends StaticFloatBin1D {
     ...
     * 
     * @return the geometric mean; <code>Float.NaN</code> if
     ...
     * 
     * @return the harmonic mean; <code>Float.NaN</code> if
     ...
     * 
     * @return the kurtosis; <code>Float.NaN</code> if <code>!hasSumOfPowers(4)</code>.
     * @see #hasSumOfPowers(int)
     */
     ...
     *             if <code>k &lt; 0</code>.
     * @return <code>Float.NaN</code> if <code>!hasSumOfPower(k)</code>.
     */
     ...
     * 
     * @return the product; <code>Float.NaN</code> if <code>!hasSumOfLogarithms()</code>
     *         .
     ...
     * 
     * @return the skew; <code>Float.NaN</code> if <code>!hasSumOfPowers(3)</code>.
     * @see #hasSumOfPowers(int)
     */
     ...
     * 
     * @return the sum of inversions; <code>Float.NaN</code> if
     *         <code>!hasSumOfInversions()</code>.
     * @see #hasSumOfInversions()
     */
     ...
     * 
     * @return the sum of logarithms; <code>Float.NaN</code> if
     *         <code>!hasSumOfLogarithms()</code>.
     * @see #hasSumOfLogarithms()
     */
     ...
     * @return the sum of powers; <code>Float.NaN</code> if
