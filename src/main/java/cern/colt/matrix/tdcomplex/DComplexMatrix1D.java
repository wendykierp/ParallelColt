...
public abstract class DComplexMatrix1D extends AbstractMatrix1D {
     ...
     * is an instance of type <code>DenseDComplexMatrix1D</code> the new matrix must
     * also be of type <code>DenseDComplexMatrix1D</code>. In general, the new
     ...
     * receiver is an instance of type <code>DenseDComplexMatrix1D</code> the new
     * matrix must be of type <code>DenseDComplexMatrix2D</code>.
     * 
     * @param rows
