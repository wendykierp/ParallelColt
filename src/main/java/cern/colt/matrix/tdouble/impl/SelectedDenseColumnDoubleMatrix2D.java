...
class SelectedDenseColumnDoubleMatrix2D extends DoubleMatrix2D {
     ...
     * <code>DenseColDoubleMatrix2D</code> the new matrix must also be of type
     * <code>DenseColDoubleMatrix2D</code>, if the receiver is an instance of type
     * <code>SparseColDoubleMatrix2D</code> the new matrix must also be of type
     * <code>SparseColDoubleMatrix2D</code>, etc. In general, the new matrix should
     ...
     * receiver is an instance of type <code>DenseColDoubleMatrix2D</code> the new
     * matrix must be of type <code>DenseDoubleMatrix1D</code>, if the receiver is
     * an instance of type <code>SparseColDoubleMatrix2D</code> the new matrix must
     * be of type <code>SparseDoubleMatrix1D</code>, etc.
     * 
     * @param size
     ...
     * instance of type <code>DenseColDoubleMatrix2D</code> the new matrix must be
     * of type <code>DenseDoubleMatrix1D</code>, if the receiver is an instance of
     * type <code>SparseColDoubleMatrix2D</code> the new matrix must be of type
