...
/**
 * Factory for convenient construction of 1-d matrices holding <code>float</code>
 * cells. Use idioms like <code>FloatFactory1D.dense.make(1000)</code> to construct
 * dense matrices, <code>FloatFactory1D.sparse.make(1000)</code> to construct sparse
 * matrices.
 * 
