...
/**
 * Abstract base class for 3-d matrices holding <code>float</code> elements. First
...
public abstract class FloatMatrix3D extends AbstractMatrix3D {
     ...
     * are <code>a(1) == f(get(0,0,0)), a(0)==Float.NaN</code>.
     * <p>
     * <b>Example:</b>
     * 
     * <pre>
     ...
     * and terminators are
     * <code>a(1) == f(get(0,0,0),other.get(0,0,0)), a(0)==Float.NaN</code>.
     * <p>
     * <b>Example:</b>
     * 
     * <pre>
     ...
     * <code>DenseFloatMatrix3D</code> the new matrix must also be of type
     * <code>DenseFloatMatrix3D</code>, if the receiver is an instance of type
     * <code>SparseFloatMatrix3D</code> the new matrix must also be of type
     * <code>SparseFloatMatrix3D</code>, etc. In general, the new matrix should have
     ...
     * instance of type <code>DenseFloatMatrix3D</code> the new matrix must also be
     * of type <code>DenseFloatMatrix2D</code>, if the receiver is an instance of
     * type <code>SparseFloatMatrix3D</code> the new matrix must also be of type
     * <code>SparseFloatMatrix2D</code>, etc.
     * 
     * @param rows
     *            the number of rows the matrix shall have.
     * @param columns
