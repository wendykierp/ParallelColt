...
public abstract class LongMatrix2D extends AbstractMatrix2D {
     ...
     * <code>a(1) == f(get(0,0)), a(0)==Long.NaN</code>.
     * <p>
     * <b>Example:</b>
     * 
     * <pre>
     ...
     * and terminators are
     * <code>a(1) == f(get(0,0),other.get(0,0)), a(0)==Long.NaN</code>.
     * <p>
     * <b>Example:</b>
     * 
     * <pre>
     ...
     * if the receiver is an instance of type <code>DenseLongMatrix2D</code> the new
     * matrix must also be of type <code>DenseLongMatrix2D</code>, if the receiver
     * is an instance of type <code>SparseLongMatrix2D</code> the new matrix must
     * also be of type <code>SparseLongMatrix2D</code>, etc. In general, the new
