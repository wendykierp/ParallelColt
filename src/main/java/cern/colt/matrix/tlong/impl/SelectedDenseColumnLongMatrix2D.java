...
/**
 * Selection view on dense 2-d matrices holding <code>long</code> elements. First
...
class SelectedDenseColumnLongMatrix2D extends LongMatrix2D {
     ...
     * <code>DenseColLongMatrix2D</code> the new matrix must also be of type
     * <code>DenseColLongMatrix2D</code>, if the receiver is an instance of type
     * <code>SparseColLongMatrix2D</code> the new matrix must also be of type
     * <code>SparseColLongMatrix2D</code>, etc. In general, the new matrix should
     ...
     * receiver is an instance of type <code>DenseColLongMatrix2D</code> the new
     * matrix must be of type <code>DenseLongMatrix1D</code>, if the receiver is an
     * instance of type <code>SparseColLongMatrix2D</code> the new matrix must be of
     ...
     * instance of type <code>DenseColLongMatrix2D</code> the new matrix must be of
     * type <code>DenseLongMatrix1D</code>, if the receiver is an instance of type
     * <code>SparseColLongMatrix2D</code> the new matrix must be of type
