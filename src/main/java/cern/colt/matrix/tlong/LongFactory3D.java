 ...
 * cells. Use idioms like <code>LongFactory3D.dense.make(4,4,4)</code> to construct
 * dense matrices, <code>LongFactory3D.sparse.make(4,4,4)</code> to construct sparse
 * matrices.
 * 
