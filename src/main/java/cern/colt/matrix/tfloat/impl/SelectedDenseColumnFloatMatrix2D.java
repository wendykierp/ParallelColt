...
/**
 * Selection view on dense 2-d matrices holding <code>float</code> elements. First
...
class SelectedDenseColumnFloatMatrix2D extends FloatMatrix2D {
     ...
     * <code>DenseColFloatMatrix2D</code> the new matrix must also be of type
     * <code>DenseColFloatMatrix2D</code>, if the receiver is an instance of type
     * <code>SparseColFloatMatrix2D</code> the new matrix must also be of type
     * <code>SparseColFloatMatrix2D</code>, etc. In general, the new matrix should
     ...
     * receiver is an instance of type <code>DenseColFloatMatrix2D</code> the new
     * matrix must be of type <code>DenseFloatMatrix1D</code>, if the receiver is an
     * instance of type <code>SparseColFloatMatrix2D</code> the new matrix must be
     * of type <code>SparseFloatMatrix1D</code>, etc.
     * 
     * @param size
     ...
     * instance of type <code>DenseColFloatMatrix2D</code> the new matrix must be of
     * type <code>DenseFloatMatrix1D</code>, if the receiver is an instance of type
     * <code>SparseColFloatMatrix2D</code> the new matrix must be of type
