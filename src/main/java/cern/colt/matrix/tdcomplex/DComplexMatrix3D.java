...
public abstract class DComplexMatrix3D extends AbstractMatrix3D {
     ...
     * @return a new view.
     * @throws IndexOutOfBoundsException
     *             if <code>sliceStride &lt;= 0 || rowStride &lt;= 0 || columnStride &lt;= 0</code>
     */
     ...
     * Construct and returns a new 2-d matrix <i>of the corresponding dynamic
     * type</i>, sharing the same cells. For example, if the receiver is an
     * instance of type <code>DenseDComplexMatrix3D</code> the new matrix must also
     * be of type <code>DenseDComplexMatrix2D</code>, if the receiver is an instance
     * of type <code>SparseDComplexMatrix3D</code> the new matrix must also be of
     * type <code>SparseDComplexMatrix2D</code>, etc.
     * 
     * @param rows
     *            the number of rows the matrix shall have.
     * @param columns
