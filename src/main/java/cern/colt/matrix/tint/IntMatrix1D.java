...
public abstract class IntMatrix1D extends AbstractMatrix1D {
     ...
     * <code>a(1) == f(get(0)), a(0)==Int.NaN</code>.
     * <p>
     * <b>Example:</b>
     * 
     * <pre>
     ...
     * are <code>a(1) == f(get(0),other.get(0)), a(0)==Int.NaN</code>.
     * <p>
     * <b>Example:</b>
     * 
     * <pre>
     ...
     * instance of type <code>DenseIntMatrix1D</code> the new matrix must also be of
     * type <code>DenseIntMatrix1D</code>, if the receiver is an instance of type
     * <code>SparseIntMatrix1D</code> the new matrix must also be of type
