...
/**
 * Factory for convenient construction of 2-d matrices holding <code>double</code>
 ...
 * <td>Use idioms like <code>DoubleFactory2D.dense.make(4,4)</code> to construct
 * dense matrices, <code>DoubleFactory2D.sparse.make(4,4)</code> to construct sparse
 * matrices.</td>
 * </tr>
 * <tr align="left" valign="top">
...
public class DoubleFactory2D extends cern.colt.PersistentObject {
    ...
    public void demo1() {
        ...
        DoubleMatrix2D[][] parts4 = { { A, tmp, A, tmp }, { tmp, A, tmp, B } };
        System.out.println("\n" + compose(parts4));
    ...
    public void demo2() {
        ...
        C = make(4, 3, 3);
        D = make(2, 2, 4);
        DoubleMatrix2D[][] parts1 = { { tmp, A, tmp }, { B, tmp, C }, { tmp, D, tmp } };
