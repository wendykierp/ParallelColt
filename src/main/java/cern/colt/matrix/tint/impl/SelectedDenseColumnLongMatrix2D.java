...
class SelectedDenseColumnIntMatrix2D extends IntMatrix2D {
     ...
     * <code>DenseColIntMatrix2D</code> the new matrix must also be of type
     * <code>DenseColIntMatrix2D</code>, if the receiver is an instance of type
     * <code>SparseColIntMatrix2D</code> the new matrix must also be of type
     * <code>SparseColIntMatrix2D</code>, etc. In general, the new matrix should
     ...
     * receiver is an instance of type <code>DenseColIntMatrix2D</code> the new
     * matrix must be of type <code>DenseIntMatrix1D</code>, if the receiver is an
     * instance of type <code>SparseColIntMatrix2D</code> the new matrix must be of
     * type <code>SparseIntMatrix1D</code>, etc.
     * 
     * @param size
     ...
     * instance of type <code>DenseColIntMatrix2D</code> the new matrix must be of
     * type <code>DenseIntMatrix1D</code>, if the receiver is an instance of type
     * <code>SparseColIntMatrix2D</code> the new matrix must be of type
