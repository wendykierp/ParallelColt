...
/**
 * Factory for convenient construction of 1-d matrices holding <code>int</code>
 * cells. Use idioms like <code>LongFactory1D.dense.make(1000)</code> to construct
 * dense matrices, <code>LongFactory1D.sparse.make(1000)</code> to construct sparse
 * matrices.
 * 
