...
/**
 * Selection view on dense 2-d matrices holding <code>Object</code> elements. First
...
class SelectedDenseColumnObjectMatrix2D extends ObjectMatrix2D {
     ...
     * <code>DenseColObjectMatrix2D</code> the new matrix must also be of type
     * <code>DenseColObjectMatrix2D</code>, if the receiver is an instance of type
     * <code>SparseColObjectMatrix2D</code> the new matrix must also be of type
     * <code>SparseColObjectMatrix2D</code>, etc. In general, the new matrix should
     ...
     * receiver is an instance of type <code>DenseColObjectMatrix2D</code> the new
     * matrix must be of type <code>DenseObjectMatrix1D</code>, if the receiver is an
     * instance of type <code>SparseColObjectMatrix2D</code> the new matrix must be of
     * type <code>SparseObjectMatrix1D</code>, etc.
     * 
     * @param size
     ...
     * instance of type <code>DenseColObjectMatrix2D</code> the new matrix must be of
     * type <code>DenseObjectMatrix1D</code>, if the receiver is an instance of type
     * <code>SparseColObjectMatrix2D</code> the new matrix must be of type
