...
/**
 * Factory for convenient construction of 3-d matrices holding <code>double</code>
 * cells. Use idioms like <code>DoubleFactory3D.dense.make(4,4,4)</code> to
 * construct dense matrices, <code>DoubleFactory3D.sparse.make(4,4,4)</code> to
