 ...
 * <td>Use idioms like <code>LongFactory2D.dense.make(4,4)</code> to construct dense
 * matrices, <code>LongFactory2D.sparse.make(4,4)</code> to construct sparse
 * matrices.</td>
 * </tr>
 * <tr align="left" valign="top">
...
public class LongFactory2D extends cern.colt.PersistentObject {
    ...
    public void demo1() {
        ...
        LongMatrix2D A = ascending(2, 2);
        LongMatrix2D B = descending(2, 2);
        LongMatrix2D tmp = null;

        LongMatrix2D[][] parts4 = { { A, tmp, A, tmp }, { tmp, A, tmp, B } };
        System.out.println("\n" + compose(parts4));
    ...
    public void demo2() {
        ...
        C = make(4, 3, 3);
        D = make(2, 2, 4);
        LongMatrix2D[][] parts1 = { { tmp, A, tmp }, { B, tmp, C }, { tmp, D, tmp } };
